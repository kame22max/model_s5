...
import 'package:model_s5/memo_page.dart';
import 'package:model_s5/register.dart';
import 'package:model_s5/settings_page.dart';
import 'package:model_s5/theme.dart';
...
class _LoginState extends State<Login> {
  ...
  bool _isObscure = true;//パスワードを見えなくする。
                  ...
                  children: <Widget>[
                    ...
                    Column(children: <Widget>[
                      ...
                      SizedBox(
                        width: 320,
                        child: TextField(
                          keyboardType: TextInputType.visiblePassword,//キーボード
